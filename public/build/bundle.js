...
var app = (function () {
    ...
    /* src/ProgressBar.svelte generated by Svelte v3.50.1 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 18, 12, 413);
    			attr_dev(div0, "class", "progress-bar svelte-r4tuc");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			add_location(div0, file$3, 17, 8, 347);
    			attr_dev(div1, "class", "progress-container svelte-r4tuc");
    			attr_dev(div1, "bp", "offset-5@md 4@md 12@sm");
    			add_location(div1, file$3, 16, 4, 278);
    			attr_dev(div2, "bp", "grid");
    			add_location(div2, file$3, 15, 0, 258);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-90jcxl");
    			add_location(h2, file$2, 41, 4, 948);
    			attr_dev(div0, "bp", "grid");
    			add_location(div0, file$2, 40, 0, 928);
    			button.disabled = /*isRunning*/ ctx[1];
    			attr_dev(button, "bp", "offset-5@md 4@md 12@sm");
    			attr_dev(button, "class", "start svelte-90jcxl");
    			add_location(button, file$2, 50, 4, 1091);
    			attr_dev(div1, "bp", "grid");
    			add_location(div1, file$2, 49, 0, 1071);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondLeft*/ 1) {
    			$$invalidate(2, progress = 100 * (TOTALSECONDS - secondLeft) / TOTALSECONDS);
    		}
    	};
    ...
    /* src/HowTo.svelte generated by Svelte v3.50.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1ilt23p");
    			add_location(img, file$1, 6, 4, 75);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1iujep4");
    			add_location(h1, file, 13, 0, 202);
    			attr_dev(a0, "href", "http://www.who.int/gpsc/clean_hands_protection/en/");
    			add_location(a0, file, 19, 1, 274);
    			attr_dev(a1, "href", "https://freesound.org/people/metrostock99/sounds/345086/");
    			add_location(a1, file, 22, 1, 361);
    			attr_dev(h3, "class", "svelte-1iujep4");
    			add_location(h3, file, 18, 0, 268);
    			if (!src_url_equal(source.src, source_src_value = "sound.wav")) attr_dev(source, "src", source_src_value);
    			add_location(source, file, 28, 1, 485);
    			add_location(audio_1, file, 27, 0, 458);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
